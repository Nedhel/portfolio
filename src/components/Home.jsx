    ...
    return (
        <div className='grid grid-cols-3 mt-8'>
            ...
            <div className=' justify-self-start relative'>
                <div className='bg-gradient-to-tr from-transparent to-gray-700 absolute -left-40 text-sm p-4'>
            ...
            <div className=' justify-self-start'>
                <div className='bg-gradient-to-tr from-transparent to-gray-700 text-sm p-4'>
                    <pre className='font-[Consolas]'>
