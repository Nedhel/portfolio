        ...
        <div className='bg-conic h-screen'>
            <div className='flex justify-around h-full items-center'>
                <div className='w-1/3 flex flex-col justify-around h-3/4 text-center'>
                    <h6 className='text-lg text-terciary'>Front-End Developer</h6>
                ...
                <div className='w-1/2 h-3/4 flex flex-col justify-between'>
                    ...
                    <div className='bg-gradient-to-tr from-transparent to-gray-700 text-sm p-3 max-w-fit self-center'>
                        <p className='font-[Consolas]'>
                    ...
                    <div className='bg-gradient-to-tr from-transparent to-gray-700 text-sm p-5 max-w-fit'>
                        <p className='font-[Consolas]'>
